            ...
            <Paper elevation={3} sx={{ padding: 2, marginBottom: 3 }}>
                ...
                <List>
                    {starterQuestions.map((question, index) => (
                        <ListItem button key={index} onClick={() => handleStarterQuestionClick(question)}>
                            {question}
                        </ListItem>
                    ))}
                </List>
