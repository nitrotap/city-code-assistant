    ...
    return (
        <div className="homepage">
            <header className="header">
                <h1>Trinidad CO Municipal Code Assistant</h1>
            </header>
            ...
            <section className="description">
                ...
                <p><strong>Disclaimer:</strong> The information provided by this service is for general informational purposes only and does not constitute legal advice. The City of Trinidad, Colorado, the developers, and any associated parties are not responsible for any errors or omissions in the content. The responses generated by this service are based on data processed using the OpenAI Assistant API, which operates under <a href="https://platform.openai.com/docs/usage-policies" target="_blank">OpenAI's usage policies and guidelines</a>. Please review <a href="https://openai.com/terms" target="_blank">OpenAI's Terms of Use</a> and <a href="https://openai.com/privacy" target="_blank">Privacy Policy</a> for more information. The content may not always reflect the most current legal standards or interpretations. For specific legal concerns, please consult a qualified attorney or the appropriate government officials.</p>
            </section>
